...
using XenostrapClient.ServerAuthInterface.Proxy;
using XenostrapClient.ServerAuthInterface.Web;

namespace XenostrapClient.ServerAuthInterface;
...
internal class Program
{
	...
	private static void Main(string[] args)
	{
		...
		Config.Load(args);
		Logger.Instance.Info($"Xenostrap Server Authorization Interface {Assembly.GetExecutingAssembly().GetName().Version}");
		...
		XenostrapClient.ServerAuthInterface.Proxy.Server server = new XenostrapClient.ServerAuthInterface.Proxy.Server();
		...
		list.Add(XenostrapClient.ServerAuthInterface.Web.Server.Start(Lifetime.Token));
