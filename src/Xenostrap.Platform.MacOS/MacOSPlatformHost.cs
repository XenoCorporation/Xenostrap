...
namespace Xenostrap.Platform.MacOS;
...
public sealed class MacOSPaths : PlatformPathsBase
{
	...
	private static PlatformStoragePaths CreateStorage()
	{
		...
		string applicationSupport = Path.Combine(home, "Library", "Application Support", "Xenostrap");
		string cache = Path.Combine(home, "Library", "Caches", "Xenostrap");
		string logs = Path.Combine(home, "Library", "Logs", "Xenostrap");
