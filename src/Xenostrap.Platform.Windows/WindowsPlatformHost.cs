...
namespace Xenostrap.Platform.Windows;
...
public sealed class WindowsPaths : PlatformPathsBase
{
	...
	{
		string baseDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Xenostrap");
		string temp = Path.Combine(Path.GetTempPath(), "Xenostrap");
