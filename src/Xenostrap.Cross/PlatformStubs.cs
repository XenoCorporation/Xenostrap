...
namespace Xenostrap.UI.Elements.Bootstrapper.Base
{
	public class WinFormsDialogBase : System.Windows.Forms.Control, Xenostrap.UI.IBootstrapperDialog
	{
		private readonly Xenostrap.UI.Elements.Bootstrapper.CustomDialog _dialog = new();

		public Xenostrap.Bootstrapper? Bootstrapper
		{
...
{
	public class CustomDialog : System.Windows.Window, Xenostrap.UI.IBootstrapperDialog
	{
		...
		public Xenostrap.Bootstrapper? Bootstrapper { get; set; }
	...
	public class VistaDialog : Xenostrap.UI.Elements.Bootstrapper.Base.WinFormsDialogBase
	{
	}

	public class LegacyDialog2008 : Xenostrap.UI.Elements.Bootstrapper.Base.WinFormsDialogBase
	{
	}

	public class LegacyDialog2011 : Xenostrap.UI.Elements.Bootstrapper.Base.WinFormsDialogBase
	{
	}

	public class ProgressDialog : Xenostrap.UI.Elements.Bootstrapper.Base.WinFormsDialogBase
	{
	}
}

namespace Xenostrap.Integrations.RiShade
{
