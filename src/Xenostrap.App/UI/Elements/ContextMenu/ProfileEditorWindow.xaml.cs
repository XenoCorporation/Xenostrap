...
namespace Xenostrap.UI.Elements.ContextMenu
{
    ...
    public partial class ProfileEditorWindow
    {
        ...
        private async void ProfileEditorWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                StatusText.Text = "Sign in to the Xenostrap website to edit your profile.";
        ...
        private async void Save_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Saved = true;
                    Xenostrap.UI.Frontend.ShowMessageBox(message ?? "Your changes are queued and will apply automatically once Cloudflare recovers.", System.Windows.MessageBoxImage.Information);
                    Close();
                    return;
                }
