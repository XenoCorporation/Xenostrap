...
namespace Xenostrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        private static readonly string[] RootNames = { "XenostrapCustomBootstrapper", "BloxstrapCustomBootstrapper" };
        ...
        private static Dictionary<string, HandleXmlElementDelegate> _elementHandlerMap = new Dictionary<string, HandleXmlElementDelegate>()
        {
            ...
            ["XenostrapCustomBootstrapper"] = HandleXmlElement_BloxstrapCustomBootstrapper_Fake,
