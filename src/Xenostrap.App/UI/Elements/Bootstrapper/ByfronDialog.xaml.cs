...
public partial class ByfronDialog : Window,IBootstrapperDialog{
	...
	public ByfronDialog()
	{
		...
		base.Icon = Xenostrap.Extensions.IconEx.GetBootstrapperWindowIcon();
		if (App.Settings.Prop.Theme2.GetFinal() == Theme.Light)
		{
			...
			_viewModel.ByfronLogoLocation = Xenostrap.Utility.SafeImaging.FromUri(new Uri("pack://application:,,,/Resources/BootstrapperStyles/ByfronDialog/ByfronLogoLight.jpg"));
		}
