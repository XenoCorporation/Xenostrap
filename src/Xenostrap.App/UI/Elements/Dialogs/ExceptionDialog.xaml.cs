...
public partial class ExceptionDialog : WpfUiWindow{
	...
	public ExceptionDialog(Exception exception)
	{
		...
		string text = "https://github.com/XenoCorporation/Xenostrap";
		...
		Xenostrap.Utility.SafeSystemSounds.Play(Xenostrap.Utility.SafeSystemSounds.Get(MessageBoxImage.Hand));
