...
using Xenostrap.UI.ViewModels.Dialogs;
...
public partial class AddCustomThemeDialog : WpfUiWindow{
	...
	private static void WriteThemeIcon(string target)
	{
		try
		{
			var source = System.Windows.Application.GetResourceStream(new Uri("pack://application:,,,/Xenostrap.png"));
	...
	private void Import()
	{
		...
		try
		{
			Xenostrap.Utility.SafeZipExtractor.ExtractToDirectory(_viewModel.FilePath, staging, true, 536870912L, 10000);
