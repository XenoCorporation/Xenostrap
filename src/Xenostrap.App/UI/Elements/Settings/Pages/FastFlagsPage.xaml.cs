...
public partial class FastFlagsPage : UiPage{
	...
	{
		string payload = await Xenostrap.Utility.Http.GetStringBoundedAsync(_httpClient, AllowlistJsonUrl).ConfigureAwait(continueOnCapturedContext: false);
	...
	private static readonly HttpClient _httpClient = Xenostrap.Utility.VpnHttpClient.Create(TimeSpan.FromSeconds(25L));
