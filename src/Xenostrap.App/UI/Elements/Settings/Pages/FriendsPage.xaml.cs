...
namespace Xenostrap.UI.Elements.Settings.Pages
{
    ...
    public partial class FriendsPage : UiPage, INotifyPropertyChanged
    {
        ...
        public string StateSubtitle => _state switch
        {
            ...
            PageState.SignedOut => "Sign in on the Home page to see your Xenostrap friends.",
            PageState.NoResults => "Try a different name or username.",
            PageState.Empty => _errorMessage.Length > 0 ? _errorMessage : "Add people on the Xenostrap website and they will show up here.",
            _ => "",
        };
