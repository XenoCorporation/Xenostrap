...
public partial class AppearancePage : UiPage{
	...
	public void CustomThemeSelection(object sender, SelectionChangedEventArgs e)
	{
		...
		if (_customThemeSelectionReady && selectedTheme != null)
			_appearanceViewModel.Dialog = Xenostrap.Enums.BootstrapperStyle.CustomDialog;
	...
	{
		string requestUri = "https://raw.githubusercontent.com/XenoCorporation/XenostrapCustomThemes/main/Custom.xaml";
		string destinationPath = Paths.CustomThemeXaml;
		try
		{
			if (!File.Exists(destinationPath))
			{
				string contents = await Xenostrap.Utility.Http.GetString(requestUri);
