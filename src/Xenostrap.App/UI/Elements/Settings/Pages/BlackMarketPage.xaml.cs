...
public partial class BlackMarketPage
{
    ...
    private void Page_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        Xenostrap.Utility.MarketBackground.Apply();
        _ = LoadAsync();
    }
    ...
    private void Page_Unloaded(object sender, RoutedEventArgs e)
    {
        ...
        _cts = null;
        Xenostrap.Utility.MarketBackground.Restore();
    }
    ...
    private static async Task<string?> GetAsync(string url, CancellationToken token)
    {
        try
        {
            ...
            return await Xenostrap.Utility.Http.ReadStringBoundedAsync(response.Content, 4 * 1024 * 1024, token).ConfigureAwait(false);
        }
        catch (Exception)
        {
            return null;
