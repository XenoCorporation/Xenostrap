...
using Xenostrap.Integrations.Nvidia;
...
public partial class NvidiaFFlagEditorPage : UiPage
{
    ...
    private static readonly string NipPath = Path.Combine(NipDirectory, "Xenostrap.nip");
    ...
    private void SetupFileWatcher()
    {
        ...
        _watcher = new FileSystemWatcher(NipDirectory, "Xenostrap.nip")
        {
