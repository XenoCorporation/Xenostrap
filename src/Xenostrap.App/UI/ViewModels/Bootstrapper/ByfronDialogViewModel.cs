...
namespace Xenostrap.UI.ViewModels.Bootstrapper;

public class ByfronDialogViewModel : BootstrapperDialogViewModel
{
	public ImageSource ByfronLogoLocation { get; set; } = Xenostrap.Utility.SafeImaging.FromUri(new Uri("pack://application:,,,/Resources/BootstrapperStyles/ByfronDialog/ByfronLogoDark.jpg"));
