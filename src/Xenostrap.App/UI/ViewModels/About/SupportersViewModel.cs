...
using Xenostrap.Models.APIs.Config;
...
public class SupportersViewModel : NotifyPropertyChangedViewModel, IDisposable
{
	...
	public async Task LoadSupporterDataAsync()
	{
		try
		{
			SupporterData = await GitHubCache.GetJsonAsync<SupporterData>("https://raw.githubusercontent.com/XenoCorporation/Xenostrap/main/assets/supportersdata7.json", TimeSpan.FromHours(1), _lifetimeCts.Token);
		}
