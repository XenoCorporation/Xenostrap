...
internal static class WindowsRegistry
{
	...
	public static void RegisterXenostrap()
	{
		if (!Platform.SupportsRegistry)
		{
			return;
		}
		RegisterProtocol("xenostrap", "Xenostrap", Paths.Application, "-theme \"%1\"");
	}
	...
	public static void RegisterApis()
	{
		...
		try
		{
			using RegistryKey registryKey = Registry.CurrentUser.CreateSubKey("Software\\Xenostrap");
