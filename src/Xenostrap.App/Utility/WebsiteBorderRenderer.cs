...
namespace Xenostrap.Utility
{
    ...
    public static class WebsiteBorderRenderer
    {
        ...
        private static IEnumerable<string> EnumerateCacheCandidates()
        {
            ...
            {
                yield return Path.Combine(documents, "Xenostrap", "WebImages");
            }
            ...
            {
                yield return Path.Combine(temp, "Xenostrap", "WebImages");
            }
        }
        ...
        public static ImageSource LoadSecureImage(string image)
        {
            try
            {
                ...
                var bmp = Xenostrap.Utility.SafeImaging.FromStream(new System.IO.MemoryStream(bytes), 256);
                if (bmp.CanFreeze)
                    bmp.Freeze();
                return bmp;
            }
