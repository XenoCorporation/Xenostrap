...
using ShellLink;
using Xenostrap.Core.Installation;
...
{
	private const string UninstallKey = "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Xenostrap";

	private const string ApiKey = "Software\\Xenostrap";

	private static string DefaultLocation => Path.Combine(Paths.LocalAppData, "Xenostrap");
	...
	private static string ApplicationFileName => Platform.IsWindows ? "Xenostrap.exe" : "Xenostrap";
