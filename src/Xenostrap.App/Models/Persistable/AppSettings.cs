...
namespace Xenostrap.Models.Persistable
{
    /// <summary>
    /// Represents configuration settings for Xenostrap.
    /// </summary>
    public class AppSettings
    {
        ...
        public BootstrapperIcon BootstrapperIcon { get; set; } = BootstrapperIcon.IconXenostrap;
        ...
        public string XenostrapMatchmakerPresetUrl { get; set; } = "";
        ...
        public List<Xenostrap.Models.DMKeybind> DoubleMovementKeybinds { get; set; } = [];
        ...
        public BootstrapperIcon RobloxIcon { get; set; } = BootstrapperIcon.IconXenostrap;
        public string RobloxIconCustomLocation { get; set; } = "";
        public string RobloxTitle { get; set; } = "Xenostrap";
        ...
        public bool XenostrapMatchmakerAutoCandidates { get; set; } = true;
        public List<string> XenostrapMatchmakerDisabledDatacenters { get; set; } = [];
        public bool XenostrapMatchmakerEnabled { get; set; } = false;
        public List<string> XenostrapMatchmakerKickDatacenters { get; set; } = [];
        public int XenostrapMatchmakerLearningGamesPlayed { get; set; } = 0;
        public int XenostrapMatchmakerMaxCandidates { get; set; } = 14;
        public bool XenostrapMatchmakerPreferEmpty { get; set; } = false;
        public string XenostrapMatchmakerPreferredDatacenter { get; set; } = "";
        public bool XenostrapMatchmakerRejoinDisabledDatacenters { get; set; } = false;
        public int XenostrapMatchmakerGamejoinApiVersion { get; set; } = 1;
        ...
        public Xenostrap.Enums.ModApplyTarget ModApplyTarget { get; set; } = Xenostrap.Enums.ModApplyTarget.Both;
        ...
        public ObservableCollection<Xenostrap.Models.CustomBackground> WebCustomBackgrounds { get; set; } = [];
