namespace Xenostrap.Integrations.GameChat
{
    public static class GameChatStrings
    {
        public const string AboutText = "About Xenostrap Chat:\nA cross server chat overlay built into Xenostrap.\nChat with everyone in your Roblox server, whether they use Xenostrap or not you can invite them.\nPowered by the Xenostrap website API.\nSource: https://github.com/XenoCorporation/Xenostrap";
        public const string AlreadyUpToDate = "Already up to date ({0})";
        public const string BannedFromChat = "You are banned from the Xenostrap chat.";
        public const string BugSending = "Sending your bug report to the Xenostrap team...";
        public const string BugSent = "Thanks! Your bug report was sent to the Xenostrap developers.";
        ...
        public const string EmoteQueued = "Emote '{0}' sent. It will play if this game has Xenostrap emote integration.";
        public const string FailedToQueueEmote = "Failed to queue emote.";
        public const string UnknownError = "Unknown error.";
        public const string VerifyChecking = "Verifying with your Xenostrap account...";
        public const string VerifySuccess = "Verified as {0}! You can now use /emote.";
        public const string VerifyNotSignedIn = "Sign in to your Xenostrap account first, then chat '/verify' again.";
        ...
        public const string UpdateAvailable = "A new Xenostrap update is available ({0}). Opening the download page...";
        ...
        public const string LoginBrowserOpened = "Opening the Xenostrap sign in page in your browser. Finish signing in there.";
        ...
        public const string DebugConsoleTitle = "Xenostrap Chat Debugger";
        ...
        public const string HelpHeader = "Xenostrap Chat commands";
        ...
        public const string BridgeWelcome = "All Bootstrappers reaches everyone in your Roblox server who runs a bootstrapper with this chat, not just Xenostrap users.";
        public const string BridgeConsent = "This tab is off by default because it uses a community server outside Xenostrap (hermivore.cat). Turning it on shares your Roblox username, user id and current server job id with that server. Chat '/bridge on' to turn it on, or '/bridge off' at any time to stop.";
        ...
        [
            ...
            ("/update", "check for Xenostrap updates"),
            ("/login", "sign in with your Xenostrap account"),
            ("/logout", "sign out of your Xenostrap account"),
