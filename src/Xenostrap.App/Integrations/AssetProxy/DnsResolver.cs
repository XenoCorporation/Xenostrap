...
namespace Xenostrap.Integrations.AssetProxy
{
    internal static class DnsResolver
    {
        ...
        private static readonly HttpClient _dohClient = Xenostrap.Utility.VpnHttpClient.Create(TimeSpan.FromSeconds(5));
        ...
        {
            int version = Xenostrap.Utility.VpnHttpClient.NetworkVersion;
