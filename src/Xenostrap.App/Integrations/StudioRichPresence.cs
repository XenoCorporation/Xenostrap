...
public sealed class StudioRichPresence : IDisposable
{
	...
	private static readonly HttpClient Http = Xenostrap.Utility.VpnHttpClient.Create(TimeSpan.FromSeconds(10));
	...
	{
		Xenostrap.Integrations.Studio.StudioState? state = Xenostrap.Integrations.Studio.StudioBridge.GetFreshState(TimeSpan.FromSeconds(12));
	...
	private void UpdatePresence()
	{
		...
		buttons.Add(new DiscordRPC.Button { Label = "Get Xenostrap", Url = App.WebsiteBaseUrl });
