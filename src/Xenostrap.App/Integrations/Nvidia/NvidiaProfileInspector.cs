...
namespace Xenostrap.Integrations.Nvidia;
...
public static class NvidiaProfileInspector
{
    ...
    public const string DefaultProfileName = "Xenostrap";

    public const string NeedsElevationMessage = "Windows only lets an administrator change driver profile settings. Restart Xenostrap as administrator and apply again";
