...
using Interop = Xenostrap.Integrations.AntiAliasing.AntiAliasingInterop;

namespace Xenostrap.Integrations.Overlays
{
    internal sealed class OverlayCompositor
    {
        private const string ClassName = "XenostrapOverlayCompositor";
        private const string CaptureWindowName = "Xenostrap Game Output";
        ...
        private void SetRecordingVisibility(bool visible)
        {
            ...
            App.Logger.WriteLine(LOG_IDENT, visible
                ? "OBS output ready as Xenostrap Game Output"
        ...
        private void ReleaseGenerationHeadroomCap()
        {
            ...
            try
            {
                ...
                Xenostrap.Integrations.FrameGeneration.FrameGenManager.SetTargetCap(0);
            }
            catch (Exception ex)
            {
